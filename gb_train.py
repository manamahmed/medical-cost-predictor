...
#     ('encoder', OneHotEncoder(handle_unknown='ignore')) # For encoding categorical value
# ])
...
# pipeline = Pipeline([
#     ('preprocessor', preprocessor),
#     ('model', GradientBoostingRegressor(n_estimators=300, learning_rate=0.01,  max_depth=10, min_samples_split=10, random_state = 42))
# ])
